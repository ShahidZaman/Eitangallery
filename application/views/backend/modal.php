    ...
    <script type="text/javascript">
    function nconfirm_modal(delete_url)
    {
        jQuery('#modal-5').modal('show', {backdrop: 'static'});
        document.getElementById('ndelete_link').setAttribute('href' , delete_url);
    }
    </script>
    ...
    <div class="modal fade" id="modal-5">
        <div class="modal-dialog">
            <div class="modal-content" style="margin-top:100px;">
                ...
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                    <h4 class="modal-title" style="text-align:center;">Are you sure to do this ?</h4>
                </div>
                
                
                <div class="modal-footer" style="margin:0px; border-top:0px; text-align:center;">
                    <a href="#" class="btn btn-success" id="ndelete_link"><?php echo 'Confirm';?></a>
                    <button type="button" class="btn btn-info" data-dismiss="modal"><?php echo get_phrase('cancel');?></button>
                </div>
            </div>
        </div>
