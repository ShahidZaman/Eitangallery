...
<link rel="stylesheet" href="<?php echo base_url() ?>assets/js/jQuery-TE_v.1.0.5/jquery-te-Style.css">
...
<script src="<?php echo base_url() ?>assets/js/jQuery-TE_v.1.0.5/jquery-te-1.0.5.min.js"></script>
<!--
